...
# Run the program. W2hy does it crash?
# Can you fix it without chaning function call: letter_grade("B")

def letter_grade(grade): #argument is not a variable, its a constant
...
#
# Make sure to write DOCSTRINGS for your function, including TYPE CONTRACT. (done)
# Test it by running help(average_of_two) in python shell. (done)
...
def average_of_two(x, y):
     ...
     Returns the average of the two inputs of the function
     '''
     average=(x+y)/2
     return average
